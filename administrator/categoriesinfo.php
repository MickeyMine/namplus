...
class ccategories extends cTable {
	...
	function __construct() {
		...
		// cat_id
		$this->cat_id = new cField('categories', 'categories', 'x_cat_id', 'cat_id', '`cat_id`', '`cat_id`', 3, -1, FALSE, '`cat_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->cat_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cat_id'] = &$this->cat_id;

		// cat_name
		$this->cat_name = new cField('categories', 'categories', 'x_cat_name', 'cat_name', '`cat_name`', '`cat_name`', 200, -1, FALSE, '`cat_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cat_name'] = &$this->cat_name;

		// cat_description
		$this->cat_description = new cField('categories', 'categories', 'x_cat_description', 'cat_description', '`cat_description`', '`cat_description`', 200, -1, FALSE, '`cat_description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->cat_is_offer->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cat_is_offer'] = &$this->cat_is_offer;

		// cat_is_competition
		$this->cat_is_competition = new cField('categories', 'categories', 'x_cat_is_competition', 'cat_is_competition', '`cat_is_competition`', '`cat_is_competition`', 16, -1, FALSE, '`cat_is_competition`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->cat_is_competition->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cat_is_competition'] = &$this->cat_is_competition;

		// cat_order
		$this->cat_order = new cField('categories', 'categories', 'x_cat_order', 'cat_order', '`cat_order`', '`cat_order`', 3, -1, FALSE, '`cat_order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->cat_order->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cat_order'] = &$this->cat_order;

		// cat_status
		$this->cat_status = new cField('categories', 'categories', 'x_cat_status', 'cat_status', '`cat_status`', '`cat_status`', 16, -1, FALSE, '`cat_status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
