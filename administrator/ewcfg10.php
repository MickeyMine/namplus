...
define("EW_PROJECT_NAME", "namplus_v1", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{621448A2-A15A-4302-8B90-FC8E171BD28F}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'y4UzP95i3s8nAp9B', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/namplus_v1.css", TRUE); // Project stylesheet file name
...
$EW_XSS_ARRAY = array('javascript', 'vbscript', 'expression', '<applet', '<meta', '<xml', '<blink', '<link', '<style', '<script', '<embed', '<ilayer', '<layer', '<bgsound', '<title', '<base', //'<object', '<iframe', '<frame', '<frameset', 
...
// Security
define("EW_ADMIN_USER_NAME", "master", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "123456", TRUE); // Administrator password
...
// Audit trail
define("EW_AUDIT_TRAIL_PATH", "logs/", TRUE); // Audit trail path (relative to app root)
