...
$offers_offer_top_image_blobview = NULL; // Initialize page object first

class coffers_offer_top_image_blobview extends coffers {
	...
	// Page object name
	var $PageObjName = 'offers_offer_top_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('offers', 'x_offer_top_image');
...
// Create page object
if (!isset($offers_offer_top_image_blobview)) $offers_offer_top_image_blobview = new coffers_offer_top_image_blobview();

// Page init
$offers_offer_top_image_blobview->Page_Init();

// Page main
$offers_offer_top_image_blobview->Page_Main();
?>
<?php
$offers_offer_top_image_blobview->Page_Terminate();
?>
