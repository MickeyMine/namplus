...
class cusers_delete extends cusers {
	...
	function Page_Main() {
		...
		if ($this->Recordset = ew_LoadRecordset($sql)) {
			...
			if (!$res) $this->Page_Terminate("userslist.php"); // Return to list
		}
...
fusersdelete.Lists["x_privilege_id"] = {"LinkField":"x_userlevelid","Ajax":null,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($users->user_id->Visible) { // user_id ?>
		<td><span id="elh_users_user_id" class="users_user_id"><?php echo $users->user_id->FldCaption() ?></span></td>
<?php } ?>
...
<?php if ($users->user_pass->Visible) { // user_pass ?>
		<td><span id="elh_users_user_pass" class="users_user_pass"><?php echo $users->user_pass->FldCaption() ?></span></td>
<?php } ?>
<?php if ($users->privilege_id->Visible) { // privilege_id ?>
		<td><span id="elh_users_privilege_id" class="users_privilege_id"><?php echo $users->privilege_id->FldCaption() ?></span></td>
<?php } ?>
<?php if ($users->user_status->Visible) { // user_status ?>
		<td><span id="elh_users_user_status" class="users_user_status"><?php echo $users->user_status->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_user_id" class="control-group users_user_id">
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_user_pass" class="control-group users_user_pass">
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_privilege_id" class="control-group users_privilege_id">
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_user_status" class="control-group users_user_status">
