...
class ccustomers_edit extends ccustomers {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// customer_pass
			$this->customer_pass->SetDbValueDef($rsnew, $this->customer_pass->CurrentValue, "", $this->customer_pass->ReadOnly);

			// customer_first_name
			$this->customer_first_name->SetDbValueDef($rsnew, $this->customer_first_name->CurrentValue, "", $this->customer_first_name->ReadOnly);

			// customer_last_name
			$this->customer_last_name->SetDbValueDef($rsnew, $this->customer_last_name->CurrentValue, "", $this->customer_last_name->ReadOnly);

			// customer_profession
			$this->customer_profession->SetDbValueDef($rsnew, $this->customer_profession->CurrentValue, NULL, $this->customer_profession->ReadOnly);

			// customer_phone
			$this->customer_phone->SetDbValueDef($rsnew, $this->customer_phone->CurrentValue, "", $this->customer_phone->ReadOnly);

			// customer_address
			$this->customer_address->SetDbValueDef($rsnew, $this->customer_address->CurrentValue, "", $this->customer_address->ReadOnly);

			// subscription_id
			$this->subscription_id->SetDbValueDef($rsnew, $this->subscription_id->CurrentValue, NULL, $this->subscription_id->ReadOnly);

			// customer_facebook
			$this->customer_facebook->SetDbValueDef($rsnew, $this->customer_facebook->CurrentValue, "", $this->customer_facebook->ReadOnly);

			// customer_author_uid
			$this->customer_author_uid->SetDbValueDef($rsnew, $this->customer_author_uid->CurrentValue, "", $this->customer_author_uid->ReadOnly);

			// customer_provider
			$this->customer_provider->SetDbValueDef($rsnew, $this->customer_provider->CurrentValue, "", $this->customer_provider->ReadOnly);

			// customer_payment_type
			$this->customer_payment_type->SetDbValueDef($rsnew, $this->customer_payment_type->CurrentValue, 0, $this->customer_payment_type->ReadOnly);

			// customer_status
			$this->customer_status->SetDbValueDef($rsnew, $this->customer_status->CurrentValue, 0, $this->customer_status->ReadOnly);

			// customer_first_login
			$this->customer_first_login->SetDbValueDef($rsnew, $this->customer_first_login->CurrentValue, 0, $this->customer_first_login->ReadOnly);
...
fcustomersedit.Lists["x_subscription_id"] = {"LinkField":"x_subscription_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_subscription_type","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php echo $customers->customer_id->EditValue ?></span>
</span>
<input type="hidden" data-field="x_customer_id" name="x_customer_id" id="x_customer_id" value="<?php echo ew_HtmlEncode($customers->customer_id->CurrentValue) ?>">
<?php echo $customers->customer_id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="password" data-field="x_customer_pass" name="x_customer_pass" id="x_customer_pass" value="<?php echo $customers->customer_pass->EditValue ?>" size="30" maxlength="50"<?php echo $customers->customer_pass->EditAttributes() ?>>
</span>
...
<script type="text/javascript">
fcustomersedit.Lists["x_subscription_id"].Options = <?php echo (is_array($customers->subscription_id->EditValue)) ? ew_ArrayToJson($customers->subscription_id->EditValue, 1) : "[]" ?>;
</script>
</span>
