...
fusersview.Lists["x_privilege_id"] = {"LinkField":"x_userlevelid","Ajax":null,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($users->user_pass->Visible) { // user_pass ?>
	<tr id="r_user_pass">
		<td><span id="elh_users_user_pass"><?php echo $users->user_pass->FldCaption() ?></span></td>
...
<?php echo $users->user_pass->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($users->privilege_id->Visible) { // privilege_id ?>
	<tr id="r_privilege_id">
		<td><span id="elh_users_privilege_id"><?php echo $users->privilege_id->FldCaption() ?></span></td>
...
<?php echo $users->privilege_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($users->user_status->Visible) { // user_status ?>
	<tr id="r_user_status">
		<td><span id="elh_users_user_status"><?php echo $users->user_status->FldCaption() ?></span></td>
...
<?php echo $users->user_status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
