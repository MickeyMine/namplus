...
//
// Table class for payment_type
//
class cpayment_type extends cTable {
	var $payment_id;
	var $payment_type;
	...
	function __construct() {
		...
		// payment_id
		$this->payment_id = new cField('payment_type', 'payment_type', 'x_payment_id', 'payment_id', '`payment_id`', '`payment_id`', 3, -1, FALSE, '`payment_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->payment_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['payment_id'] = &$this->payment_id;

		// payment_type
		$this->payment_type = new cField('payment_type', 'payment_type', 'x_payment_type', 'payment_type', '`payment_type`', '`payment_type`', 200, -1, FALSE, '`payment_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("payment_typeview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("payment_typeview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "payment_typeadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("payment_typeedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("payment_typeadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("payment_typedelete.php", $this->UrlParm());
	}
