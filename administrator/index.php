...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'image_gallery'))
			$this->Page_Terminate("image_gallerylist.php");
		if ($Security->AllowList(CurrentProjectID() . 'news'))
			$this->Page_Terminate("newslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'offer_answers'))
			$this->Page_Terminate("offer_answerslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'offer_locations'))
			$this->Page_Terminate("offer_locationslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'offer_questions'))
		...
		if ($Security->AllowList(CurrentProjectID() . 'subscriptions'))
			$this->Page_Terminate("subscriptionslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'users'))
			$this->Page_Terminate("userslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'register_form'))
			$this->Page_Terminate("register_formlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'payment_type'))
			$this->Page_Terminate("payment_typelist.php");
		if ($Security->AllowList(CurrentProjectID() . 'offer_cus_answers'))
