...
class cusers_list extends cusers {
	...
	function BasicSearchSQL($Keyword) {
		...
		$sWhere = "";
		$this->BuildBasicSearchSQL($sWhere, $this->user_name, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $this->user_pass, $Keyword);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->privilege_id); // privilege_id
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<label class=\"checkbox\"><input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->user_id->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event, this);'></label>";
...
fuserslist.Lists["x_privilege_id"] = {"LinkField":"x_userlevelid","Ajax":null,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($users->user_id->Visible) { // user_id ?>
	<?php if ($users->SortUrl($users->user_id) == "") { ?>
		<td><div id="elh_users_user_id" class="users_user_id"><div class="ewTableHeaderCaption"><?php echo $users->user_id->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->user_id) ?>',1);"><div id="elh_users_user_id" class="users_user_id">
...
<?php if ($users->user_name->Visible) { // user_name ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->user_name) ?>',1);"><div id="elh_users_user_name" class="users_user_name">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->user_name->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($users->user_name->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->user_name->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($users->user_pass->Visible) { // user_pass ?>
	<?php if ($users->SortUrl($users->user_pass) == "") { ?>
		<td><div id="elh_users_user_pass" class="users_user_pass"><div class="ewTableHeaderCaption"><?php echo $users->user_pass->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->user_pass) ?>',1);"><div id="elh_users_user_pass" class="users_user_pass">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->user_pass->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($users->user_pass->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->user_pass->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($users->privilege_id->Visible) { // privilege_id ?>
	<?php if ($users->SortUrl($users->privilege_id) == "") { ?>
		<td><div id="elh_users_privilege_id" class="users_privilege_id"><div class="ewTableHeaderCaption"><?php echo $users->privilege_id->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->privilege_id) ?>',1);"><div id="elh_users_privilege_id" class="users_privilege_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->privilege_id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($users->privilege_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->privilege_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($users->user_status->Visible) { // user_status ?>
	<?php if ($users->SortUrl($users->user_status) == "") { ?>
		<td><div id="elh_users_user_status" class="users_user_status"><div class="ewTableHeaderCaption"><?php echo $users->user_status->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->user_status) ?>',1);"><div id="elh_users_user_status" class="users_user_status">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->user_status->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($users->user_status->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->user_status->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
<span<?php echo $users->user_pass->ViewAttributes() ?>>
<?php echo $users->user_pass->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($users->privilege_id->Visible) { // privilege_id ?>
		<td<?php echo $users->privilege_id->CellAttributes() ?>>
<span<?php echo $users->privilege_id->ViewAttributes() ?>>
<?php echo $users->privilege_id->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($users->user_status->Visible) { // user_status ?>
		<td<?php echo $users->user_status->CellAttributes() ?>>
<span<?php echo $users->user_status->ViewAttributes() ?>>
<?php echo $users->user_status->ListViewValue() ?></span>
</td>
	<?php } ?>
<?php
