...
<?php
	$GoogleMapJs = "http" . (ew_IsHttps() ? "s" : "") . "://maps.googleapis.com/maps/api/js?sensor=false";
?>
<script src="<?php echo $GoogleMapJs ?>"></script>
<script type="text/javascript" src="phpjs/ewgooglemaps.js"></script>

<!-- My scripts -->
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false"></script>
<script language="javascript" type="text/javascript" src="phpjs/jsGoogleMap.js"></script>
<script language="javascript" type="text/javascript">
	var positionX = "x_location_map_x";
    var positionY = "x_location_map_y";
</script>
<script language="javascript" type="text/javascript" src="phpjs/jquery.timepicker.js"></script>
<link rel="stylesheet" type="text/css" href="phpcss/jquery.timepicker.css">
<!-- End my scripts -->
